var player = function (_x,_y) {
    ...
    this.interactions = function() {
        ...
        // Is touching the key?
        if(this.x == Game.maze.key_coordinates[0] && this.y == Game.maze.key_coordinates[1]) {
            this.has_key = true;
        }

        // Is in the Exit
        if(this.x == Game.maze.exit_coordinates[0] && this.y == Game.maze.exit_coordinates[1]) {
            if(!this.has_key) {
    ...
    this.canMoveTo = function(target_x, target_y) {
        ...
        if(target_x < 0 || target_y < 0 || target_y > Game.maze.rows - 1 || target_x > Game.maze.cols - 1)
        {
