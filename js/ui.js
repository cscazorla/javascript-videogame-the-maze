var UI = function() {
    ...
    this.showWelcomeScreen = function() {
        ...
        this.createWindow('#eeeeee', '#000', Game.canvas.width/4, Game.canvas.height/5);

        Game.ctx.font="bold 40px Georgia";
        Game.ctx.fillStyle = '#000';
        Game.ctx.textAlign = "center";
        Game.ctx.fillText("The Maze", Game.canvas.width/2, Game.canvas.height/3);
        
        var btn1 = new Button("Beginner", Game.canvas.width/2 - 80, Game.canvas.height/2.25 - 40, 160, 40, Game.ctx);
        var btn2 = new Button("Intermediate", Game.canvas.width/2 - 80, Game.canvas.height/2.25 + 20, 160, 40, Game.ctx);
        var btn3 = new Button("Expert", Game.canvas.width/2 - 80, Game.canvas.height/2.25 + 80, 160, 40, Game.ctx);
        var btn4 = new Button("Master", Game.canvas.width/2 - 80, Game.canvas.height/2.25 + 140, 160, 40, Game.ctx);
    ...
    this.showGameOverScreen = function() {
        this.createWindow('#1c6a9e', '#fff', Game.canvas.width/4, Game.canvas.height/4);
